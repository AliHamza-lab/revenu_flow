        ...
        <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-6 bg-[radial-gradient(circle_at_center,rgba(255,0,0,0.05)_0%,transparent_70%)]">
            <div className="w-full max-w-md">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-black tracking-tight uppercase italic mb-2">ACCESS TERMINAL</h1>
                    <p className="text-gray-500 text-xs font-bold tracking-[0.2em] uppercase">Initialize Career OS Execution</p>
                </div>
                ...
                <div className="bg-white/[0.02] border border-white/5 p-8 rounded-[32px] backdrop-blur-xl">
                    ...
                    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex justify-between items-center px-4">
                                <label className="text-[10px] font-bold text-gray-500 tracking-widest uppercase">Secret (Password)</label>
                                <a href="#" className="text-[8px] font-bold text-red-500 tracking-widest uppercase hover:underline">Lost Secret?</a>
                            </div>
                            <input
                                type="password"
                                value={password}
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-[10px] font-bold text-gray-400 tracking-widest uppercase">
                            NOT ON THE NETWORK? <Link to="/signup" className="text-red-500 hover:underline">INITIATE SIGNUP</Link>
                        </p>
                    </div>
                </div>
            </div>
