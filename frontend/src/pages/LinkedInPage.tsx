        ...
        <div className="min-h-screen bg-[#050505] text-white flex">
            ...
            <main className="flex-1 overflow-y-auto pt-16 lg:pt-0 min-w-0">
                <div className="p-4 sm:p-6 lg:p-10">
                    <header className="text-left mb-8 lg:mb-12">
                        <div className="text-red-500 text-[10px] font-black uppercase tracking-[0.3em] mb-2">Network Influence</div>
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black italic uppercase tracking-tighter">LinkedIn Architect</h1>
                    </header>
