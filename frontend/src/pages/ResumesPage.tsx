            ...
            <main className="flex-1 p-10 overflow-y-auto">
                <header className="flex justify-between items-end mb-12">
                    <div className="text-left">
                        ...
                        <h1 className="text-5xl font-black italic uppercase tracking-tighter">Resume Treasury</h1>
                    </div>
                    <label className="px-8 py-4 bg-red-600 rounded-2xl flex items-center gap-3 font-black uppercase tracking-widest text-xs hover:bg-red-700 transition-all cursor-pointer shadow-[0_0_30px_rgba(255,0,0,0.2)]">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {resumes.map(resume => (
                            <div key={resume.id} className="p-8 bg-white/[0.02] border border-white/5 rounded-[32px] hover:bg-white/[0.04] transition-all group">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        <div className="w-16 h-16 bg-red-600/10 rounded-2xl flex items-center justify-center text-red-500 group-hover:bg-red-600 group-hover:text-white transition-all shadow-[inset_0_0_20px_rgba(255,0,0,0.1)]">
                                        ...
                                        <div className="text-left">
                                            <h3 className="text-lg font-black uppercase italic tracking-tight">{resume.title}</h3>
                                    ...
                                    <div className="flex items-center gap-8">
                                        <div className="text-right">
                                            <div className="text-[10px] text-red-500 font-black uppercase tracking-widest mb-1 text-right">Last Intel Score</div>
                                            <div className="text-3xl font-black italic">{resume.last_score || 'N/A'}</div>
                                        </div>
                                        <button
                                            onClick={() => setShowAnalyze(resume.id)}
                                            className="px-6 py-3 bg-white text-black rounded-xl font-black uppercase tracking-[0.15em] text-[10px] hover:bg-neutral-200 transition-all"
                                        >
                                            Analyze Strength
                                        </button>
                                    </div>
